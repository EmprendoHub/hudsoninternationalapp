...
export function cstDateTime() {
  ...
  if (process.env.NODE_ENV === "development") {
    ...
    console.log(process.env.NODE_ENV, cstTime);
...
export function formatDate(dateTimeString, lang) {
  // Create a Date object from the given string
  ...
  const formattedDateEs = cstDate.toLocaleDateString("es-ES", {
    year: "numeric",
    month: "long",
    day: "numeric",
  });
  ...
  const formattedDateEn = cstDate.toLocaleDateString("en-US", {
    year: "numeric",
    month: "long",
    day: "numeric",
  });

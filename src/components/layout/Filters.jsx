...
const Filters = ({ allCategories }) => {
  ...
  return (
    <aside className="maxmd:w-1/3 lg:w-1/4 px-4">
      <a
        className="maxmd:hidden mb-5  w-full text-center px-4 py-2 inline-block text-lg text-gray-700 bg-white shadow-sm border border-gray-200 rounded-md hover:bg-gray-100 hover:text-darkblue-600"
        href="#"
      >
        Filtrar por
      </a>

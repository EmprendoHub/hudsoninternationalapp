  ...
  return (
    <aside className=" w-1/4 maxmd:w-full px-4 py-8 flex flex-col maxmd:flex-row  items-start justify-start">
      <ul className="sidebar flex flex-col maxmd:flex-row">
        <Link
          href="/perfil"
          className="block px-3 py-2 text-gray-800 hover:bg-blue-100 hover:text-darkblue-500 rounded-md"
        >
      ...
      <ul className="sidebar flex flex-col maxmd:flex-row">
        ...
        <li>
          <div
            className="block px-3 py-2 text-red-800 hover:bg-red-100 hover:text-darkwhite-500 rounded-md cursor-pointer flex flex-row items-center gap-x-3"
            onClick={() => signOut()}
          >

  ...
  return (
    <aside className=" w-1/5 maxmd:w-full px-4 maxsm:px-2 py-8 flex flex-col maxmd:flex-row maxmd:justify-between maxmd:items-center items-start justify-start">
      <ul className="sidebar flex flex-col maxmd:flex-row gap-x-2 ">
        <Link
          href="/afiliado"
          className="block px-3 maxsm:px-1 py-2 text-gray-800 hover:bg-blue-100 hover:text-darkblue-500 rounded-md"
        >
      ...
      <ul className="sidebar flex flex-col maxmd:flex-row gap-x-2">
        ...
        <li>
          <div
            className=" px-3 maxsm:px-1 py-2 text-red-800 hover:bg-red-100 hover:text-darkwhite-500 rounded-md cursor-pointer flex flex-row items-center gap-x-3"
            onClick={() => signOut()}
          >

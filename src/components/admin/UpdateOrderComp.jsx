"use client";
import { changeOrderNoteStatus, updateOneOrder } from "@/app/[lang]/_actions";
  ...
  return (
    ...
    >
      ...
      <div className="maxsm:w-[90%]  flex flex-col items-center justify-center gap-3 p-7 maxsm:p-4 bg-slate-200">
        <h2 className="font-bold font-primary">Actualizar Pedido</h2>
        ...
        <div className="flex items-center gap-3 ">
          <div
            ...
            className={`bg-red-700 text-white py-2 px-8 text-xl hover:bg-slate-200 hover:text-darkred-900 ease-in-out duration-700 rounded-md cursor-pointer`}
          >
            Cancelar
          </div>
          <button

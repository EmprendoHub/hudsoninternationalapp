...
import { updateAffiliate } from "@/app/[lang]/_actions";
import { TiCancel } from "react-icons/ti";

const AdminAffiliates = ({ affiliates, filteredAffiliatesCount }) => {
    ...
    <>
      ...
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
        <div className=" flex flex-row maxsm:flex-col maxsm:items-start items-center justify-between">
          {" "}
          <h1 className="text-3xl my-5 ml-4 font-bold font-primary">
                ...
                <td className="px-1 py-2  w-24 flex flex-row">
                  <div>
                    <Link
                      ...
                      className="px-2 py-2 inline-block text-white hover:text-darkblack bg-black shadow-sm border border-gray-200 rounded-md hover:bg-gray-100 cursor-pointer mr-2"
                    >
                  ...
                  <div>
                    <button
                      ...
                      className="px-2 py-2 inline-block text-white hover:text-darkblack bg-slate-400 shadow-sm border border-gray-200 rounded-md hover:bg-gray-100 cursor-pointer mr-2"
                    >
                      <TiCancel className="" />
                    </button>
                  </div>

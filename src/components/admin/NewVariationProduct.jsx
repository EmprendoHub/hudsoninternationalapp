...
import { addVariationProduct } from "@/app/[lang]/_actions";
      ...
      >
        <section className="w-full ">
          <div className="flex flex-row maxmd:flex-col items-center justify-between">
            <h1 className="w-full text-xl font-semibold text-black mb-8 font-primary">
              Nuevo Producto Con Variaciones
            </h1>

            <div className="mb-4 w-full flex flex-row gap-4 items-center uppercase">
              <div className="relative">
                <label className="block mb-1 font-primary">destacado</label>
                <select
              ...
              <div className="relative">
                <label className="block mb-1 font-primary">instagram</label>
                <select
                  className="block appearance-none border border-gray-300 bg-gray-100 rounded-md py-2 px-3 focus:outline-none focus:border-gray-400 w-full"
              ...
              <div className="relative">
                <label className="block mb-1 font-primary">sucursal</label>
                <select
                  className="block appearance-none border border-gray-300 bg-gray-100 rounded-md py-2 px-3 focus:outline-none focus:border-gray-400 w-full"
              ...
              <div className="relative">
                <label className="block mb-1 font-primary">www</label>
                <select
                  className="block appearance-none border border-gray-300 bg-gray-100 rounded-md py-2 px-3 focus:outline-none focus:border-gray-400 w-full"
          ...
          <div className="flex flex-row maxmd:flex-col items-start gap-5 justify-between w-full">
            <div className="gap-y-1 flex-col flex px-2 w-full">
              ...
              <label className="block  font-primary">Imagen principal</label>
            ...
            <div className="w-full flex-col flex justify-start px-2 gap-y-5">
              <div className="mb-4">
                <label className="block mb-1  font-primary"> Titulo</label>
                <input
                  type="text"
              ...
              <div className="mb-4">
                <label className="block mb-1  font-primary">
                  {" "}
                  Description Corta
                </label>
                <textarea
              ...
              <div className="mb-4">
                <label className="block mb-1  font-primary"> Marca</label>
                <input
                  type="text"
                  className="appearance-none border bg-gray-100 rounded-md py-2 px-3 border-gray-300 focus:outline-none focus:border-gray-400 w-full"
              ...
              <div className="mb-4 w-full">
                <label className="block mb-1 font-primary"> Género </label>
                <div className="relative">
                  <select
                    className="block appearance-none border border-gray-300 bg-gray-100 rounded-md py-2 px-3 focus:outline-none focus:border-gray-400 w-full"
                    name="gender"
              ...
              <div className="mb-4 w-full">
                <label className="block mb-1 font-primary">Etiquetas</label>
                <div className="relative">
              ...
              <div className="mb-4 w-full">
                <label className="block mb-1 font-primary"> Categoría </label>
                <div className="relative">
                  <select
          ...
          <div className="w-full main-variation">
            <div className="flex flex-row maxsm:flex-col items-center gap-5">
              <div className="mb-4 w-full">
                <label className="block mb-1 font-primary"> Talla </label>
                <div className="relative">
                  <select
              ...
              <div className="mb-4 w-full">
                <label className="block mb-1 font-primary"> Color </label>
                <div className="relative">
                  <select
              ...
              <div className="mb-4 w-full">
                <label className="block mb-1  font-primary">Precio</label>
                <div className="relative">
                  <div className="col-span-2">
                    <input
                      type="number"
              ...
              <div className="mb-4 w-full">
                <label className="block mb-1 font-primary"> Costo </label>
                <div className="relative">
                  <div className="col-span-2">
                    <input
                      type="number"
              ...
              <div className="mb-4 w-full">
                <label className="block mb-1 font-primary"> Existencias </label>
                <div className="relative">
                  <div className="col-span-2">
                    <input
                      type="number"
              ...
              <div className="mb-4 w-full flex-col flex">
                {/* Section 1 - Title, Image */}
                <label className="block  font-primary">

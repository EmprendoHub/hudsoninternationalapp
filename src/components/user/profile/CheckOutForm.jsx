      ...
      <div className="container max-w-screen-xl mx-auto bg-white flex flex-col justify-between p-2">
        ...
        {isLoggedIn ? (
          <div className="flex flex-col items-center gap-1">
            ...
            <Link
              href="/tienda"
              className="px-4 mt-3 py-3 inline-block text-lg w-full text-center font-medium bg-white shadow-sm border border-gray-200 rounded-md hover:bg-gray-100 text-black  font-raleway"
            >
          ...
          <div>
            ...
            {!session && (
              <>
                ...
                <Link
                  href="/tienda"
                  className="px-4 py-3 inline-block text-lg w-full text-center font-medium bg-white shadow-sm border border-gray-200 rounded-md hover:bg-gray-100 text-black  font-raleway"
                >
                  Regresar a la Tienda
                </Link>
              </>

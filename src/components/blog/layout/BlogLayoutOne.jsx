...
const BlogLayoutOne = ({ blog, lang }) => {
  return (
    <div className="group relative h-full overflow-hidden rounded-sm">
      <div
        className="absolute top-0 left-0 bottom-0 right-0 h-full
            bg-gradient-to-b from-transparent from-0% to-zinc-950 rounded-sm z-10
            "
      />
      <Image
      ...
      <div className="w-full absolute bottom-0 p-4 xs:p-6 sm:p-10 z-20">
        ...
        >
          <h2 className="font-bold capitalize text-sm xs:text-base sm:text-xl md:text-2xl text-light mt-2 sm:mt-4">
            <span
              className="bg-gradient-to-r text-white font-primary from-orange-400 to-orange-600 bg-[length:0px_2px] dark:from-accentDark/50 dark:to-accentDark/50

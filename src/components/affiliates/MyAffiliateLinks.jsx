          ...
          <div className="flex flex-col justify-between items-center gap-1">
            <span>
              <button
                ...
                className="px-2 py-2 inline-block text-white hover:text-darkred-600 bg-red-600 shadow-sm border border-gray-200 rounded-md hover:bg-gray-100 cursor-pointer "
              >
                <FaTrash className="" />
              </button>
            </span>

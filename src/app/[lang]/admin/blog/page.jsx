...
import { getAllPost } from "@/app/[lang]/_actions";
import AdminPosts from "@/components/admin/AdminPosts";

const AdminPostsPage = async ({ searchParams, params }) => {
  ...
  return (
    <>
      <div className="container mx-auto mt-8">
        <AdminPosts posts={posts} lang={lang} />
                ...
                <Link
                  ...
                  className={
                    page === pageNumber
                      ...
                      : "hover:bg-black px-1 rounded-full w-8 h-8 flex justify-center items-center hover:text-darkwhite"
                  }
